...
float quantization::dithered_8_bit_scalar_quantization_wrapper(
    ...
    quantization::DitheredQuantization8Strategy strategy = quantization::DitheredQuantization8Strategy(dithered_scale);
    strategy.quantize_scalar(input);

    return input.std_quantization_input.scale;
}

float quantization::dithered_8_bit_quantization_wrapper(
    py::array_t<float> dq_values,
    py::array_t<int8_t> q_values,
    float dithered_scale
) {
...
float quantization::dithered_8_bit_quantization_parallel_wrapper(
    py::array_t<float> dq_values,
    py::array_t<int8_t> q_values,
    float dithered_scale
) {
...
void quantization::dithered_8_bit_quantization_grouped_wrapper(
    py::array_t<float> dq_values,
    py::array_t<int8_t> q_values,
...
void quantization::dithered_8_bit_quantization_grouped_parallel_wrapper(
    py::array_t<float> dq_values,
    py::array_t<int8_t> q_values,
    py::array_t<float> scales,
    py::array_t<float> dq_consts,
