...
void sparse::uq_sparse_conv2d_vectorized_forward_stride_1_wrapper(
    ...
    sparse::sparse_conv2d_vectorized_forward_stride_1(
        B, IC, OC, M, N, K, W_nnz, padding, ptr_X, ptr_W_idx_OC, ptr_W_idx_IC,
        ptr_W_idx_X, ptr_W_idx_Y, ptr_W_val, ptr_O
    );
}

void sparse::uq_sparse_conv2d_vectorized_backward_stride_1_wrapper(
    py::array_t<float> X, py::array_t<int> W_idx_OC,
    py::array_t<int16_t> W_idx_IC, py::array_t<uint8_t> W_idx_X,
    py::array_t<uint8_t> W_idx_Y, py::array_t<float> W_val,
    ...
    sparse::sparse_conv2d_vectorized_backward_stride_1(
        B, IC, OC, M, N, K, W_nnz, padding, ptr_X, ptr_W_idx_OC, ptr_W_idx_IC,
        ptr_W_idx_X, ptr_W_idx_Y, ptr_W_val, ptr_dLdO, ptr_dLdX, ptr_dLdW_val
    );
}

void sparse::uq_sparse_conv2d_vectorized_forward_stride_2_wrapper(
    py::array_t<float> X, py::array_t<int> W_idx_OC,
    py::array_t<int16_t> W_idx_IC, py::array_t<uint8_t> W_idx_X,
    py::array_t<uint8_t> W_idx_Y, py::array_t<float> W_val,
    py::array_t<float> O, int kernel_size, int padding
    ...
    sparse::sparse_conv2d_vectorized_forward_stride_2(
        B, IC, OC, M, N, K, W_nnz, padding, ptr_X, ptr_W_idx_OC, ptr_W_idx_IC,
        ptr_W_idx_X, ptr_W_idx_Y, ptr_W_val, ptr_O
    );
}

void sparse::uq_sparse_conv2d_vectorized_backward_stride_2_wrapper(
    py::array_t<float> X, py::array_t<int> W_idx_OC,
    py::array_t<int16_t> W_idx_IC, py::array_t<uint8_t> W_idx_X,
    py::array_t<uint8_t> W_idx_Y, py::array_t<float> W_val,
    py::array_t<float> dLdO, py::array_t<float> dLdX,
    ...
    sparse::sparse_conv2d_vectorized_backward_stride_2(
        B, IC, OC, M, N, K, W_nnz, padding, ptr_X, ptr_W_idx_OC, ptr_W_idx_IC,
        ptr_W_idx_X, ptr_W_idx_Y, ptr_W_val, ptr_dLdO, ptr_dLdX, ptr_dLdW_val
    );
}